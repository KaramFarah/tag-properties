...
use App\Http\Controllers\Website\CareersWebsiteController;
...
Route::group(['prefix' => 'dashboard', 'as' => 'dashboard.', 'namespace' => 'Dashboard', 'middleware' => ['auth']], function () {
    ...
    // Careers
    Route::delete('careers/destroy', 'CareersController@massDestroy')->name('campaigns.massDestroy');
    Route::resource('careers', 'CareersController');
    Route::get('careers/index-auditlogs/{id}/{class}', 'AgentsController@indexAuditlogs')->name('careers.index-auditlogs');
