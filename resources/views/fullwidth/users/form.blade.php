...
<div class="row">
    <div class="col mb-30">
        <div class="border rounded bg-white p-30">
            ...
            <div class="row">
                <div class="col-md-4">
                    <x-inputs.text inputName="emitaes_id" inputId="emitaes_id" inputLabel="{{ __('Emitaes ID') }}" inputRequired="" inputValue="{{ old('emitaes_id', $user->emitaes_id ?? '') }}" inputHint="" inputClass="" class="mb-30" type="text"/>
                </div>
                <div class="col-md-4">
                    <x-inputs.text inputName="brn" inputId="brn" inputLabel="{{ __('BRN') }}" inputRequired="" inputValue="{{ old('brn', $user->brn ?? '') }}" inputHint="" inputClass="" class="mb-30" type="text"/>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    {{-- <x-inputs.text inputName="languages" inputId="languages" inputLabel="{{ __('Spoken Languages') }}" inputRequired="" inputValue="{{ old('languages', $user->languages ?? '') }}" inputHint="" inputClass="" class="mb-30" type="text"/> --}}
